...
class OpenRouterClient:
    ...
    async def generate_caption(
        ...
        system = (
            ...
            "PLATFORM RULES:\n"
            " - youtube_shorts: title <=80 chars (punchy + curiosity gap, no clickbait shouting), "
            ...
            " - youtube_long: title <=80 chars, description 100-300 words, 10-15 tags, hashtags <=3.\n"
            " - instagram_reels: caption <=2200 chars w/ light line-breaks for readability, 10-20 hashtags inline.\n"
